...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_downcounter_fixed is
  port (
    E : out STD_LOGIC_VECTOR ( 0 to 0 );
    clk : in STD_LOGIC;
    ext_reset : in STD_LOGIC
  );
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_downcounter_fixed;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_downcounter_fixed is
...
the_RC_clock: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_downcounter_fixed
     port map (
      E(0) => enable,
      clk => clk,
      ext_reset => ext_reset
