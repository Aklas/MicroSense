...
#
# Generated by export_simulation on Fri Dec 08 12:31:19 -0800 2017
#
################################################################################
...
'-reset_run' switch to the './microSense_top_level.sh' script.

./microSense_top_level.sh -reset_run
...
./microSense_top_level.sh -noclean_files

For more information on the script, please type './microSense_top_level.sh -help'.
