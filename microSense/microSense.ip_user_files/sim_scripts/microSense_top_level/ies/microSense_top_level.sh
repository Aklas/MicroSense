...
execute()
{
  irun $irun_opts \
       ...
       -top xil_defaultlib.microSense_top_level \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"../../../../microSense.srcs/sources_1/bd/microSense_top_level/ipshared/5123" \
       +incdir+"../../../../microSense.srcs/sources_1/bd/microSense_top_level/ipshared/ec67/hdl"
}
