...
HD_PWD='C:/Users/Aklas/Desktop/microSense_topLevel/microSense/microSense.runs/microSense_top_level_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microSense_top_level_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microSense_top_level_xbar_0.tcl
