...
HD_PWD='C:/Users/Aklas/Desktop/microSense_topLevel/microSense/microSense.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log microSense_top_level_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source microSense_top_level_wrapper.tcl -notrace
