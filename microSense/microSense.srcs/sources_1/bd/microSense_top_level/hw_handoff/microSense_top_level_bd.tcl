...
################################################################
# This is a generated script based on design: microSense_top_level
#
...
# source microSense_top_level_script.tcl
...
set design_name microSense_top_level
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set SAR_in [ create_bd_port -dir I SAR_in ]
  set SAR_out [ create_bd_port -dir O SAR_out ]
  ...
  # Create instance: top_level_SAR_0, and set properties
  set top_level_SAR_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:top_level_SAR:1.0 top_level_SAR_0 ]
  ...
  # Create port connections
  connect_bd_net -net SAR_in_1 [get_bd_ports SAR_in] [get_bd_pins top_level_SAR_0/SAR_input]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_pins axi_gpio_1/gpio_io_o] [get_bd_pins vga_module_0/pixel]
  connect_bd_net -net axi_gpio_2_gpio2_io_o [get_bd_pins axi_gpio_2/gpio2_io_o] [get_bd_pins vga_module_0/we]
  connect_bd_net -net axi_gpio_2_gpio_io_o [get_bd_pins axi_gpio_2/gpio_io_o] [get_bd_pins vga_module_0/addr]
  ...
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins clk_wiz_0/reset] [get_bd_pins rst_clk_wiz_0_100M/ext_reset_in] [get_bd_pins top_level_SAR_0/ext_reset]
  ...
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins top_level_SAR_0/clk] [get_bd_pins vga_module_0/clk]
  connect_bd_net -net top_level_SAR_0_SAR_output [get_bd_ports SAR_out] [get_bd_pins top_level_SAR_0/SAR_output]
  connect_bd_net -net top_level_SAR_0_distance_mm [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins top_level_SAR_0/distance_mm]
  connect_bd_net -net vga_module_0_blue [get_bd_ports blue] [get_bd_pins vga_module_0/blue]
  connect_bd_net -net vga_module_0_green [get_bd_ports green] [get_bd_pins vga_module_0/green]
  connect_bd_net -net vga_module_0_hsync [get_bd_ports hsync] [get_bd_pins vga_module_0/hsync]
  connect_bd_net -net vga_module_0_red [get_bd_ports red] [get_bd_pins vga_module_0/red]
  connect_bd_net -net vga_module_0_vsync [get_bd_ports vsync] [get_bd_pins vga_module_0/vsync]
