...
HD_PWD='C:/Users/Aklas/Desktop/microSense_topLevel/sar/sar.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_SAR.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_SAR.tcl
