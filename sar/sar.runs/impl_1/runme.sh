...
HD_PWD='C:/Users/Aklas/Desktop/microSense_topLevel/sar/sar.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_SAR.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_level_SAR.tcl -notrace
