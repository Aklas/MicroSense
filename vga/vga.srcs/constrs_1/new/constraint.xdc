...
## Switches
#set_property PACKAGE_PIN V17 [get_ports {distance[0]}]					
...
#set_property PACKAGE_PIN W16 [get_ports {distance[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {distance[2]}]
#set_property PACKAGE_PIN W17 [get_ports {distance[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {distance[3]}]
#set_property PACKAGE_PIN W15 [get_ports {distance[4]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {distance[4]}]
#set_property PACKAGE_PIN V15 [get_ports {distance[5]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {distance[5]}]
#set_property PACKAGE_PIN W14 [get_ports {distance[6]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {distance[6]}]
#set_property PACKAGE_PIN W13 [get_ports {distance[7]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {distance[7]}]
#set_property PACKAGE_PIN V2 [get_ports {distance[8]}]					
...
#set_property PACKAGE_PIN U1 [get_ports {we}]					
...
##Pmod Header JA
##Sch name = JA1
#set_property PACKAGE_PIN J1 [get_ports {SAR_in}]							
#	set_property IOSTANDARD LVCMOS33 [get_ports {SAR_in}]
###Sch name = JA2
#set_property PACKAGE_PIN L2 [get_ports {SAR_out}]							
#	set_property IOSTANDARD LVCMOS33 [get_ports {SAR_out}]
##Sch name = JA3
